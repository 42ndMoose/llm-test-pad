...
related: []
verification:
  - "Institutional holders: company proxy/DEF 14A (beneficial owners table)"
  - "Institutional holders: SEC 13F filings (EDGAR) for Vanguard/BlackRock/State Street entities"
  - "Issuer ownership pages: company investor relations (if they publish holder snapshots)"
---
